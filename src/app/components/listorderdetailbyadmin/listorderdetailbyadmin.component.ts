...
@Component({
  selector: 'app-listorderdetailbyadmin',
  templateUrl: './listorderdetailbyadmin.component.html',
  styleUrls: ['./listorderdetailbyadmin.component.css']
})
export class ListorderdetailbyadminComponent {
