...
@Component({
  selector: 'app-listproductbyuser',
  templateUrl: './listproductbyuser.component.html',
  styleUrls: ['./listproductbyuser.component.css']
})
export class ListproductbyuserComponent {
