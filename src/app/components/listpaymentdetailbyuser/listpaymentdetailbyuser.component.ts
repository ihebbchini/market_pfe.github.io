...
@Component({
  selector: 'app-listpaymentdetailbyuser',
  templateUrl: './listpaymentdetailbyuser.component.html',
  styleUrls: ['./listpaymentdetailbyuser.component.css']
})
export class ListpaymentdetailbyuserComponent {
