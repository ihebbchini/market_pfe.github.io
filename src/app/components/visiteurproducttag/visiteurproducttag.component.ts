...
@Component({
  selector: 'app-visiteurproducttag',
  templateUrl: './visiteurproducttag.component.html',
  styleUrls: ['./visiteurproducttag.component.css']
})
export class VisiteurproducttagComponent {
