...
@Component({
  selector: 'app-listdiscountbyadmin',
  templateUrl: './listdiscountbyadmin.component.html',
  styleUrls: ['./listdiscountbyadmin.component.css']
})
export class ListdiscountbyadminComponent {
