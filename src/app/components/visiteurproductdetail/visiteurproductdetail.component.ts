...
@Component({
  selector: 'app-visiteurproductdetail',
  templateUrl: './visiteurproductdetail.component.html',
  styleUrls: ['./visiteurproductdetail.component.css']
})
export class VisiteurproductdetailComponent {
