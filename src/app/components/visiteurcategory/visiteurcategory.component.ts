...
@Component({
  selector: 'app-visiteurcategory',
  templateUrl: './visiteurcategory.component.html',
  styleUrls: ['./visiteurcategory.component.css']
})
export class VisiteurcategoryComponent {
