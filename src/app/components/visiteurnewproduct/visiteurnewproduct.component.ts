...
@Component({
  selector: 'app-visiteurnewproduct',
  templateUrl: './visiteurnewproduct.component.html',
  styleUrls: ['./visiteurnewproduct.component.css']
})
export class VisiteurnewproductComponent {
