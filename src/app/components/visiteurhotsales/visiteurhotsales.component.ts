...
@Component({
  selector: 'app-visiteurhotsales',
  templateUrl: './visiteurhotsales.component.html',
  styleUrls: ['./visiteurhotsales.component.css']
})
export class VisiteurhotsalesComponent {
