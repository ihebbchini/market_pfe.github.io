...
@Component({
  selector: 'app-visiteurbestseller',
  templateUrl: './visiteurbestseller.component.html',
  styleUrls: ['./visiteurbestseller.component.css']
})
export class VisiteurbestsellerComponent {
