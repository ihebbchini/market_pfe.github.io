...
@Component({
  selector: 'app-listproductbyadmin',
  templateUrl: './listproductbyadmin.component.html',
  styleUrls: ['./listproductbyadmin.component.css']
})
export class ListproductbyadminComponent {
