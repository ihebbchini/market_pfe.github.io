...
@Component({
  selector: 'app-listuserpaiementbyuser',
  templateUrl: './listuserpaiementbyuser.component.html',
  styleUrls: ['./listuserpaiementbyuser.component.css']
})
export class ListuserpaiementbyuserComponent {
