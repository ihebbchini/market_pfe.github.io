...
@Component({
  selector: 'app-edituserpaiementbyadmin',
  templateUrl: './edituserpaiementbyadmin.component.html',
  styleUrls: ['./edituserpaiementbyadmin.component.css']
})
export class EdituserpaiementbyadminComponent {
