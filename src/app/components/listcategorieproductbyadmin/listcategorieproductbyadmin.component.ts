...
@Component({
  selector: 'app-listcategorieproductbyadmin',
  templateUrl: './listcategorieproductbyadmin.component.html',
  styleUrls: ['./listcategorieproductbyadmin.component.css']
})
export class ListcategorieproductbyadminComponent {
