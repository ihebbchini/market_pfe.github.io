...
@Component({
  selector: 'app-listinventoryproductbyuser',
  templateUrl: './listinventoryproductbyuser.component.html',
  styleUrls: ['./listinventoryproductbyuser.component.css']
})
export class ListinventoryproductbyuserComponent {
