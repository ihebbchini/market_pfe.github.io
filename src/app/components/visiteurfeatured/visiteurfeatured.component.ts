...
@Component({
  selector: 'app-visiteurfeatured',
  templateUrl: './visiteurfeatured.component.html',
  styleUrls: ['./visiteurfeatured.component.css']
})
export class VisiteurfeaturedComponent {
