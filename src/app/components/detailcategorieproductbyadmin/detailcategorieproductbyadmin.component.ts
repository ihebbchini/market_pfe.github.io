...
@Component({
  selector: 'app-detailcategorieproductbyadmin',
  templateUrl: './detailcategorieproductbyadmin.component.html',
  styleUrls: ['./detailcategorieproductbyadmin.component.css']
})
export class DetailcategorieproductbyadminComponent {
