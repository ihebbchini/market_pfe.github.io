...
@Component({
  selector: 'app-visiteurcarroussel',
  templateUrl: './visiteurcarroussel.component.html',
  styleUrls: ['./visiteurcarroussel.component.css']
})
export class VisiteurcarrousselComponent {
