...
@Component({
  selector: 'app-listcarteitembyadmin',
  templateUrl: './listcarteitembyadmin.component.html',
  styleUrls: ['./listcarteitembyadmin.component.css']
})
export class ListcarteitembyadminComponent {
