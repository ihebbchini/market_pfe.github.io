...
@Component({
  selector: 'app-detailorderitembyadmin',
  templateUrl: './detailorderitembyadmin.component.html',
  styleUrls: ['./detailorderitembyadmin.component.css']
})
export class DetailorderitembyadminComponent {
