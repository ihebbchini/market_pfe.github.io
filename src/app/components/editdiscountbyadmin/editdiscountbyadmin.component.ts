...
@Component({
  selector: 'app-editdiscountbyadmin',
  templateUrl: './editdiscountbyadmin.component.html',
  styleUrls: ['./editdiscountbyadmin.component.css']
})
export class EditdiscountbyadminComponent {
