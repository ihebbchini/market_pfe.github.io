...
@Component({
  selector: 'app-detailpaymentdetailbyadmin',
  templateUrl: './detailpaymentdetailbyadmin.component.html',
  styleUrls: ['./detailpaymentdetailbyadmin.component.css']
})
export class DetailpaymentdetailbyadminComponent {
