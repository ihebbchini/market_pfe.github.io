...
@Component({
  selector: 'app-detailuserbyadmin',
  templateUrl: './detailuserbyadmin.component.html',
  styleUrls: ['./detailuserbyadmin.component.css']
})
export class DetailuserbyadminComponent {
