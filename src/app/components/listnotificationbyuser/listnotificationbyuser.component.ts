...
@Component({
  selector: 'app-listnotificationbyuser',
  templateUrl: './listnotificationbyuser.component.html',
  styleUrls: ['./listnotificationbyuser.component.css']
})
export class ListnotificationbyuserComponent {
