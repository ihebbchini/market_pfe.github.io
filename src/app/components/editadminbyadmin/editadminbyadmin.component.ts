...
@Component({
  selector: 'app-editadminbyadmin',
  templateUrl: './editadminbyadmin.component.html',
  styleUrls: ['./editadminbyadmin.component.css']
})
export class EditadminbyadminComponent {
