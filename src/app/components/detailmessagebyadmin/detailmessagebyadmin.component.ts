...
@Component({
  selector: 'app-detailmessagebyadmin',
  templateUrl: './detailmessagebyadmin.component.html',
  styleUrls: ['./detailmessagebyadmin.component.css']
})
export class DetailmessagebyadminComponent {
