...
@Component({
  selector: 'app-visiteurmostviewed',
  templateUrl: './visiteurmostviewed.component.html',
  styleUrls: ['./visiteurmostviewed.component.css']
})
export class VisiteurmostviewedComponent {
