...
@Component({
  selector: 'app-detailuserprofilbyadmin',
  templateUrl: './detailuserprofilbyadmin.component.html',
  styleUrls: ['./detailuserprofilbyadmin.component.css']
})
export class DetailuserprofilbyadminComponent {
