...
@Component({
  selector: 'app-editinventoryproductbyadmin',
  templateUrl: './editinventoryproductbyadmin.component.html',
  styleUrls: ['./editinventoryproductbyadmin.component.css']
})
export class EditinventoryproductbyadminComponent {
