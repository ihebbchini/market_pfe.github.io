...
@Component({
  selector: 'app-editorderdetailbyadmin',
  templateUrl: './editorderdetailbyadmin.component.html',
  styleUrls: ['./editorderdetailbyadmin.component.css']
})
export class EditorderdetailbyadminComponent {
