...
@Component({
  selector: 'app-visiteurclientssays',
  templateUrl: './visiteurclientssays.component.html',
  styleUrls: ['./visiteurclientssays.component.css']
})
export class VisiteurclientssaysComponent {
